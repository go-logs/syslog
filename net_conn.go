...
func (n *netConn) writeString(framer Framer, formatter Formatter, p Priority, hostname, appName, tag, msg string) error {
	if framer == nil {
	...
	formattedMessage := framer(formatter(p, hostname, appName, tag, msg))
